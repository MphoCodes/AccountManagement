-- Create Database
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'AccountManagement')
BEGIN
...
CREATE TABLE Persons (
    ...
    CONSTRAINT PK_Persons PRIMARY KEY CLUSTERED (code)
);
GO
...
-- Insert Status Types
INSERT INTO Status (code, name) VALUES (1, 'Open');
INSERT INTO Status (code, name) VALUES (2, 'Closed');
GO
